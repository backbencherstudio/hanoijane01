export const standPackages = [
  {
    ...
    includes: [
      ...
      "1x Fascia board with company name.",
      "2x Exhibitor entry passes.",
      "Listing in the official ITBA Expo Guide.",
      "Wi-Fi (shared)",
    ],
  },
  {
    ...
    includes: [
      ...
      "2x Spotlights & 2x Power sockets.",
      "Premium fascia board with custom company logo option.",
      "4x Exhibitor entry passes.",
      "Highlighted listing in the Expo Guide & Digital Portal.",
    ],
  },
  {
