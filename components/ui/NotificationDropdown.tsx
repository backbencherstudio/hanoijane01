...
const NotificationDropdown = () => {
  return (
    <div className=" w-100  bg-white absolute top-8 right-4 rounded-2xl border">
      {/* header */}
      ...
      <div className="max-h-100 overflow-y-auto">
        {notifications.map((notification) => (
          <div key={notification.id} className="p-4 flex gap-2">
            ...
            <div className="w-full">
              <div className="w-full flex items-start justify-between">
                <h6 className="font-semibold text-[#1C1F23]">
                {notification.title}
                </h6>
